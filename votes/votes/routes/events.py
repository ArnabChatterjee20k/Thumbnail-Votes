from flask_socketio import emit, join_room, leave_room, disconnect, ConnectionRefusedError , rooms
...
def user_connect_and_validate():
    ...
    print("joining")
    sid = request.sid
    cache.cache_sid_room(project_id,sid)
    print(cache.get_sid_room())
    print(request.sid)
